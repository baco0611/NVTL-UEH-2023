...
function Stage() {
    ...
    useEffect(() => {
        axiosClient.post('/castingStage_Admin', search)
        .then(response => {
    ...
    return (
        <section id="admin-mc">
            <div className="admin-item-header">
                <h1>CASTING SÂN KHẤU</h1>
                <p>Tra cứu và xem thông tin tài khoản đăng ký casting sân khấu</p>
            ...
            <div className="admin-box admin-mc" style={{height: `${height}px`}}>
                <div className="admin-first-row admin-row">
                    ...
                    <div style={{minWidth: '175px'}}>
                        <p className="admin-row-item">Thể loại văn nghê</p>
                    </div>
                    <div style={{minWidth: '125px'}}>
                        <p className="admin-row-item">File nhạc</p>
                    </div>
                    <div style={{minWidth: '125px'}}>
                        <p className="admin-row-item">Clip mẫu</p>
                    </div>
                    ...
                    castingList.map((item, index) => {
                        return (
                            <div className="admin-row" key={index}>
                                ...
                                <div style={{minWidth: '175px'}}>
                                    <p className="admin-row-item">{item.categoryStage}</p>
                                </div>
                                <div style={{minWidth: '125px'}}>
                                    <p 
                                        className="admin-row-item center underline cursorPointer"
                                        onClick={() => showVideo(item.fileMusic, item.fileMusicName)}
                                    >
                                        Music
                                    </p>
                                </div>
                                <div style={{minWidth: '125px'}}>
                                    <p 
                                        className="admin-row-item center underline cursorPointer"
                                        onClick={() => showImage(item.clipTemplate, item.clipTemplateName)}
                                    >
                                        Video
                                    </p>
                                </div>
